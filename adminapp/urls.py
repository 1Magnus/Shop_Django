...
urlpatterns = [
    ...
    path('product/create/<int:pk>/', admin_views.ProductCreateView.as_view(), name='product_create'),
    path('product/<int:pk>/', admin_views.ProductsListView.as_view(), name='product_list'),
    path('product/update/<int:pk>/', admin_views.ProductUpdateView.as_view(), name='product_update'),
    path('product/delete/<int:pk>/', admin_views.ProductDeleteView.as_view(), name='product_delete'),
    path('product/detail/<int:pk>/', admin_views.ProductDetailView.as_view(), name='product_detail'),
